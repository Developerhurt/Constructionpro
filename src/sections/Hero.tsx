    ...
    <section className="relative pt-28 md:pt-36 pb-20 overflow-hidden">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="relative z-10">
          ...
          <motion.h1 {...fadeUp(.1)} className="text-5xl md:text-7xl font-black leading-[1.1] tracking-tight">
            Building <span className="gradient-text">future-proof</span> spaces.
          </motion.h1>
          
          <motion.p {...fadeUp(.2)} className="mt-6 text-xl text-white/80 max-w-2xl leading-relaxed">
            Design-Build • EPC • Fit-outs. On-time, on-budget, auditable delivery. 
            <span className="text-brand-300 font-medium"> Explore our ongoing and upcoming projects.</span>
          </motion.p>
          
          <motion.div {...fadeUp(.3)} className="mt-10 flex flex-col sm:flex-row gap-4">
            <a href="#ongoing" className="group relative inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-brand-500 to-brand-600 rounded-full font-semibold text-white shadow-glow hover:shadow-glow-purple transition-all duration-300 hover:scale-105">
            ...
            <a href="#contact" className="group inline-flex items-center justify-center px-8 py-4 glass rounded-full font-semibold text-white hover:bg-white/10 transition-all duration-300 hover:scale-105">
              Get Quote
          ...
          <motion.div {...fadeUp(.4)} className="mt-12 flex flex-wrap gap-8 text-sm">
            {[
              { label: "ISO-9001", icon: "✓" },
        ...
        <motion.div 
          initial={{opacity:0,scale:.9,rotateY:15}} 

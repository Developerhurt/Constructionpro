      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          >
            ...
            expertise, innovation, and commitment to excellence across various
            sectors.
          </motion.p>
        </div>
        ...
        {/* Stats Section */}
        <motion.div {...fadeUp(0.8)} className="mt-20">
          <div className="glass rounded-3xl p-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                ...
                <motion.div
                  key={stat.label}
                  {...fadeUp(0.9 + index * 0.1)}
                  className="text-center group"
                >
                  <div
                    className={`w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-r ${stat.color} flex items-center justify-center text-2xl group-hover:scale-110 transition-transform duration-300`}
                  >
                    {stat.icon}
                  </div>
                  <div
        ...
        <motion.div {...fadeUp(1)} className="mt-16 text-center">
          <div className="glass rounded-3xl p-12 max-w-4xl mx-auto">
            <h3 className="text-3xl font-bold mb-4 text-white">
              Ready to see your <span className="gradient-text">vision</span>{" "}
              come to life?
            </h3>
            <p className="text-xl text-white/80 mb-8">
              Join our portfolio of successful projects and experience the
              BUILDINGX difference.
            </p>
